...
public class MQTTManager {
    public static final String SERVER_HOST = "tcp://192.168.0.48:61680";
...
//    private MessageHandlerCallBack callBack;
    ...
    public static MQTTManager getInstance(Context context) {
        Log.d("MQQT","mqttManager="+mqttManager);
        if (mqttManager==null) {
            mqttManager=new MQTTManager(context);
            synchronized (Object.class) {
                Log.d("MQQT","synchronized mqttManager="+mqttManager);
                if (mqttManager!=null) {
                    return mqttManager;
                }
            }
        }else {
            Log.d("MQQT","else mqttManager="+mqttManager);
            return mqttManager;
        }
        return null;
    }
...
//              options.setWill(topic, "close".getBytes(), 2, true);
            ...
            Log.d("MQQT","ClientId="+client.getClientId());
    ...
    public void publish(String topic,String msg,boolean isRetained,int qos) {
        ...
        try {
            if (client!=null) {
                ...
                Log.d("MQQT","topic="+topic+"--msg="+msg+"--isRetained"+isRetained);
            }
    ...
    public class PushCallback implements MqttCallback {
        ...
        public void deliveryComplete(IMqttDeliveryToken token) {
            //publish后会执行到这里
            Log.d("MQQT","发布消息成功的回调"+token.isComplete());
        }
        ...
        public void messageArrived(final String topicName, final MqttMessage message)
            ...
            Log.d("MQQT","接收消息=="+new String(message.getPayload()));
//            if (callBack!=null) {
